    ...
    <script type="text/javascript">
    	...
    	/* function car1 (p,q,all) {
				...
				ac.onclick = function(){
					...
					if (buttoname1=="开始"){
						document.getElementById("run1").value="暂停";
						lushu.start();
						
					}
					else if (buttoname1=="暂停"){
						document.getElementById("run1").value="开始";
						lushu.pause();
						UAVflight1();
					}
				}
		...
		function car2 (p,q,all) {
				...
				ac2.onclick = function(){
					...
					if (buttoname2=="开始"){
						document.getElementById("run2").value="暂停";
						lushu.start();
						
					}
					else if (buttoname2=="暂停"){
						document.getElementById("run2").value="开始";
						lushu.pause();
						UAVflight2();
					}
				}
