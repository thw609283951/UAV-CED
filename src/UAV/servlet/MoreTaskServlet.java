...
public class MoreTaskServlet extends HttpServlet{
			...
			throws ServletException, IOException 
	{
		...
		System.out.println("**************MoreTaskServlet****************");
		String limirtimestr=request.getParameter("limittime");
		double limittime=Double.parseDouble(limirtimestr)/60;
		...
		if(tpl!=null&&uavinbaselist!=null&&tpl.size()>0&&uavinbaselist.size()>0)
		{
			...
			uis.getMoreTask(uabinbasepath,uavinbaselist,tpl,limittime);		
