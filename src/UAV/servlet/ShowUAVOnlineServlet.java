...
public class ShowUAVOnlineServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		// TODO Auto-generated method stub
	    //System.out.println("***************ShowUAVOnlineServlet****************");
		...
		List<UAVOnline> uol=new ArrayList<UAVOnline>();
		uol=uis.searchAllUAVOnline();
		UAVOnline uo=new UAVOnline();
		StringBuffer xml=new StringBuffer("<UAVOnlineList>");
